...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('template/assets/css/hope-ui.min.css?v=2.0.0') }}" />

  <!-- Custom Css -->
  <link rel="stylesheet" href="{{ asset('template/assets/css/custom.min.css?v=2.0.0') }}" />
...
<body class="  ">
  ...
  <main class="main-content">
    <div class="position-relative iq-banner">
      <!--Nav Start-->
      @include('admin.pages.layouts.navbar')
      <!-- Nav Header Component Start -->
      @include('admin.pages.layouts.navbar-header')
        ...
        <div class="col-lg-12">
          ...
          <div class="d-grid gap-3 grid-cols-2 mb-4">
            <div class="text-center">
              ...
              <img src="{{ asset('template/assets/images/settings/light/06.png') }}" alt="rounded-one-side"
                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                data-name="sidebar-item" data-value="navs-rounded">
